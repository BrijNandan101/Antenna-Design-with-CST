...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="10" encoded_unit="&amp;U:V^1.:A^1.:m^-2" fieldname="&lt;name missing&gt;" fieldtype="Powerflow" frequency="30"/>
  <MetaGeometryFile filename="model.gex" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0">
      <FieldResultFile filename="power (f=30)_1,1.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
